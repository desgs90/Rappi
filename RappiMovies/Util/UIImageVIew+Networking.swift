...
import UIKit
//MARK: - OTHER UTILS
var laguagesAvailable = [String]()
var yearsAvailable = [String]()

let movieSelectedNotificationName = "kMovieSelectedNotificationName"
//MARK: - EXTENSIONS
...
extension UIView {
    func roundCorners(_ round: CGFloat) {
